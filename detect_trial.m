function [corr,resptms] = detect_trial(stim,Fs,targettms,stimtrig,varargin)
% This test is meant to deliver an audio stimulus to a participant and
% record the times at which the participant hits the button in response to
% some target in the sound. The stimulus is preceded by a click followed by
