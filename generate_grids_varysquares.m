function [grids,targets] = generate_grids_varysquares(trial_dur,ioi)
...
% the previous one.  This code randomly selects squares to turn on and off
% on each grid, but it doesn't ensure the same number of squares is on in
% each grid.
% Inputs:
